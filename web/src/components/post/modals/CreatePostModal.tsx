...
import { X, ChevronDown, Smile, Image, UserPlus, MapPin, Video } from 'lucide-react';
...
export const CreatePostModal = ({ isOpen , onClose }: { isOpen: boolean; onClose: () => void }) => {
    ...
    return (
        ...
        {isOpen && <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 animate-fade-in">
            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-[500px] mx-auto relative flex flex-col max-h-[90vh] animate-scale-in">
                ...
                <div className="p-4 flex-1 overflow-y-auto custom-scrollbar">
                    ...
                    <div className="flex items-center space-x-3 mb-4">
                        ...
                        <div>
                            <h3 className="font-semibold text-[15px] text-gray-900 leading-tight">{userData?.Name}</h3>
                            <button className="flex items-center space-x-1 bg-gray-100 hover:bg-gray-200 rounded-md px-2 py-[2px] text-[13px] font-semibold text-gray-600 transition-colors mt-1">
                    ...
                    <div className="relative mb-4">
                        <textarea
                            ...
                            className="w-full text-gray-900 text-xl sm:text-2xl placeholder-gray-500 resize-none outline-none min-h-[150px] py-2"
                        ...
                        <div className="flex justify-between items-center mt-2">
                            <button className="p-1 hover:bg-gray-100 rounded-lg transition-colors focus:outline-none">
                                ...
                                <div className="w-9 h-9 bg-gradient-to-br from-green-400 via-blue-500 to-purple-500 rounded-lg flex items-center justify-center text-white font-bold text-sm shadow-sm">Aa</div>
                            </button>
                    ...
                    <div className="border border-gray-300 rounded-lg p-[10px] flex items-center justify-between mb-2 shadow-sm">
                        ...
                        <div className="flex -space-x-1">
                            ...
                            <button className="p-2 hover:bg-gray-100 rounded-full transition-colors focus:outline-none font-bold text-white text-xs" title="GIF">
                                <span className="bg-teal-500 px-1 py-[2px] rounded-[4px]">GIF</span>
                            </button>
                ...
                <div className="p-4 border-t border-gray-200 shrink-0">
                    <button
                        ...
                        className={`w-full py-[10px] px-4 rounded-lg font-semibold text-[15px] transition-colors focus:outline-none ${postText.trim()
